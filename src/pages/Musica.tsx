    ...
    <main className="app-page space-y-6 pb-32 fade-in" style={{ backgroundColor: '#0B0C10' }}>
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        >
          ...
          <span className="text-[10px] font-semibold text-white/70">Player</span>
        </button>
        <button
          type="button"
          className="card flex flex-col items-center gap-2 rounded-2xl border border-purple-500/20 bg-slate-900/60 p-3 text-center hover:border-purple-500/40 transition-all group"
        ...
        >
          ...
          <span className="text-[10px] font-semibold text-white/70">Álbuns</span>
        </button>
        <button
          type="button"
          className="card flex flex-col items-center gap-2 rounded-2xl border border-purple-500/20 bg-slate-900/60 p-3 text-center hover:border-purple-500/40 transition-all group"
        ...
        >
          ...
          <span className="text-[10px] font-semibold text-white/70">Artistas</span>
        </button>
        <button
          type="button"
          className="card flex flex-col items-center gap-2 rounded-2xl border border-purple-500/20 bg-slate-900/60 p-3 text-center hover:border-purple-500/40 transition-all group"
        ...
        >
          ...
          <span className="text-[10px] font-semibold text-white/70">Cifras</span>
        </button>
      </div>
              ...
              >
                <div className="relative">
                  <div className="flex h-24 items-center justify-center bg-gradient-to-br from-purple-500/20 to-indigo-500/20 p-2 text-center">
                    <span className="text-xs font-bold text-white/90 group-hover:text-purple-400 transition-colors">{playlist.nome}</span>
                  </div>
                </div>
                <div className="p-2.5">
      ...
      <section>
        <SectionHeaderInner icon={<Play className="h-4 w-4 text-purple-400" />} titulo="MAIS TOCADAS" verTodas="/biblioteca" />
            ...
            {maisTocadas.map((m) => (
              ...
              >
                ...
                <button
                  ...
                  className="p-2 rounded-xl bg-purple-500/10 hover:bg-purple-500/20 text-purple-400 hover:text-white transition-all border border-purple-500/20 shrink-0"
                  title="Tocar"
                >
      ...
      <section>
        <SectionHeaderInner icon={<Disc className="h-4 w-4 text-purple-400" />} titulo="ÁLBUNS" verTodas="/albuns" />
        <div className="flex gap-3 overflow-x-auto pb-2 no-scrollbar">
          {albuns.length === 0 ? (
      ...
      <section>
        <SectionHeaderInner icon={<User className="h-4 w-4 text-purple-400" />} titulo="ARTISTAS" verTodas="/artistas" />
        <div className="flex gap-3 overflow-x-auto pb-2 no-scrollbar">
          {artistasDerivados.length === 0 ? (
            ...
            artistasDerivados.map((artista) => (
              ...
              >
                ...
                <p className="mt-2 truncate text-xs font-bold text-white group-hover:text-purple-400 transition-colors">{artista.nome}</p>
      ...
      <section>
        <SectionHeaderInner icon={<Folder className="h-4 w-4 text-purple-400" />} titulo="PASTAS DE ÁUDIO LOCAIS" />
            ...
            {pastasLocais.map((pasta) => (
              ...
              >
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <p className="text-xs font-semibold text-white truncate group-hover:text-purple-400 transition-colors">{pasta.nome}</p>
