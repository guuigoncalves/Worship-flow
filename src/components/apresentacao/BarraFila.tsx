...
export function BarraFila({ atual, proxima, onNext }: { atual: string; proxima: string; onNext: () => void }) {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-30 border-t border-borda bg-superficie/95 px-3 py-3 backdrop-blur">
      <button type="button" onClick={onNext} className="mx-auto flex w-full max-w-3xl items-center justify-between gap-3 rounded-lg bg-elevada px-4 py-3 text-left">
